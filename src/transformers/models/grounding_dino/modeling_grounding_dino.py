...
class GroundingDinoLoss(nn.Module):
    ...
    def loss_labels(self, outputs, targets, indices, num_boxes):
        ...
        loss_ce = sigmoid_focal_loss(torch.clamp(source_logits, min=-50, max=50), target_classes_onehot, num_boxes, alpha=self.focal_alpha, gamma=2)
        # loss_ce = loss_ce * source_logits.shape[1]
